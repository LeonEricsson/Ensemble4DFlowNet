...
4D Flow MRI - extending capabilities using ensemble learning"](). This project offers two frameworks for ensembled 4D Flow MRI super-resolution, utilizing the 4DFlowNet as the base learner architecture. The implementation is done using Tensorflow 2.6.0 with Keras, and the necessary packages are listed in the requirements file.
