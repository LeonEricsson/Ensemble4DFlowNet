...
if __name__ == "__main__": 
    ...
    mask_threshold = 0.6 # Threshold for non-binary mask 
    ...
    base_path = '../../data'
    lr_file = 'example_data_LR.h5' #LowRes velocity data
    hr_file = 'example_data_HR.h5' #HiRes velocity data
    output_filename = f'{base_path}/example_data_patches.csv'
    label = 'cardiac'
    ...
    for index in file_indexes:
        ...
        pd.generate_random_patches(lr_file, hr_file, output_filename, index, n_patch, binary_mask, 
                                   patch_size, minimum_coverage, n_empty_patch_allowed, label, all_rotation)
